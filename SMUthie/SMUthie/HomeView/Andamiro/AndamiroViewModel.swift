...
class AndamiroViewModel: ObservableObject {
    @Published var menu: [AndamiroMenu] = [
        AndamiroMenu(image: "carrot.fill", name: "제육볶음", price: "가격 7000원", comment:"자극적인데 맛있어요", like : 13),
        AndamiroMenu(image: "cup.and.saucer.fill", name: "돈까스", price: "가격 7500원", comment:"그냥 맛있어요", like : 12)
    ]
